...
{
public static bool GetInfoByID(int? messageID, ref int senderID, ref int recipientID, ref string messageContent, ref DateTime messageDate, ref byte status)
{
    bool isFound = false;
...
public static int? Add(int senderID, int recipientID, string messageContent, DateTime messageDate, byte status)
{
...
public static bool Update(int? messageID, int senderID, int recipientID, string messageContent, DateTime messageDate, byte status)
{
    int rowAffected = 0;
