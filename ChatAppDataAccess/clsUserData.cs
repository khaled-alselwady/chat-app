...
namespace ChatAppDataAccess
{
    ...
    {
        public static bool GetInfoByID(int? userID, ref string username, ref string password, ref string bio, ref string imagePath)
        {
            bool isFound = false;
        ...
        public static bool GetInfoByUsername(ref int? userID, string username, ref string password, ref string bio, ref string imagePath)
        {
            bool isFound = false;
        ...
        public static bool GetInfoByUsernameAndPassword(ref int? userID, string username, string password, ref string bio, ref string imagePath)
        {
            bool isFound = false;
        ...
        public static int? Add(string username, string password, string bio, string imagePath)
        {
        ...
        public static bool Update(int? userID, string username, string password, string bio, string imagePath)
        {
            int rowAffected = 0;
